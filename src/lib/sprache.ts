 ...
 *
 * Nur noch für den Leitbegriff gebraucht: die Zuordnung selbst arbeitet seit
 * dem Umbau auf verstehen.ts nicht mehr mit Stopplisten, sondern mit
 * gewichteten Stichwörtern. Ein Füllwort steht dort schlicht nicht im
 * Lexikon und braucht deshalb auch keine Ausnahme.
 */
